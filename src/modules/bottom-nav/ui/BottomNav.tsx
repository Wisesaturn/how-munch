...
const NAV_ITEMS = [
  { href: '/store', label: '재고/가계부', icon: Package },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 z-50 w-full max-w-[430px] -translate-x-1/2 border-t border-gray-100 bg-white/95 backdrop-blur-sm">
