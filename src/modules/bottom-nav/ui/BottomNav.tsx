...
export function BottomNav() {
  ...
  return (
    <nav className="safe-area-bottom fixed right-0 bottom-0 left-0 z-50 border-t border-gray-100 bg-white/95 py-[15px] backdrop-blur-sm [--safe-area-bottom-offset:15px]">
