...
import { BottomSheet, Button, Input, Select, Toast } from '@/commons/ui';
...
interface MealEditorBottomSheetProps {
  open: boolean;
  onClose: () => void;
  householdId: string;
  date: string;
...
export function MealEditorBottomSheet({
  open,
  onClose,
  householdId,
  date,
  ...
  return (
    <BottomSheet open={open} onClose={onClose}>
      <BottomSheet.Content>
        <BottomSheet.Header heading={`${MEAL_TYPE_LABEL[type]} 식단 편집`} />
