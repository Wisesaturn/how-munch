...
-- Source: supabase/migrations/063_subdivide_fridge_item_with_unit.sql
...
-- 6. 새 fridge_item(is_subdivided=true, 부모 속성 상속, unit은 p_new_item_unit 우선)과 첫 배치를 생성합니다.
...
begin
  ...
  v_new_unit := coalesce(p_new_item_unit, v_source_item.unit);
