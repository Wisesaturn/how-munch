-- ============================================================
-- Support kg unit for ingredients and fridge items
-- ============================================================
...
alter table public.fridge_items
  add constraint fridge_items_unit_check check (unit in ('count', 'g', 'kg'));

alter table public.ingredients
  drop constraint if exists ingredients_unit_check;

alter table public.ingredients
  add constraint ingredients_unit_check check (unit in ('count', 'g', 'kg'));
